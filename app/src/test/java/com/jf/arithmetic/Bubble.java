...
//        doBubbleBetterSrt(array);
     ...
     * @param array
     */
    public void doBubbleSrt(int[] array) {
        System.out.println("排序前的数组为:" + StringUtil.print(array));
        //外层循环,遍历所有轮数
     ...
     * @param array
     */
    public void doBubbleBetterSrt(int[] array) {
        System.out.println("排序前的数组为:" + StringUtil.print(array));
        //外层循环,遍历所有轮数
        for (int i = 0; i < array.length - 1; i++) {
            //内层循环，两两比较，选中较大的数字，进行交换
    ...
    public void doBubbleBestSrt(int[] array) {
        System.out.println("排序前的数组为:" + StringUtil.print(array));
        //外层循环,遍历所有轮数
        for (int i = 0; i < array.length - 1; i++) {
            //内层循环，两两比较，选中较大的数字，进行交换
